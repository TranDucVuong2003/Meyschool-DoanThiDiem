...
<body>
    ...
    <div class="main">
        ...
        <div class="content">
            <div class="breadcrumb">
                <a href="tin-tuc-admin.php">Tin tức</a> &rsaquo; <?= $pageTitle ?>
            </div>
            ...
            <form id="newsForm" enctype="multipart/form-data">
                <input type="hidden" name="id" id="newsId" value="<?= $editId ?>">
                <div class="form-grid">
                    <!-- Cột chính -->
                    <div>
                        <div class="card">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="title" id="titleInput" placeholder="Nhập tiêu đề bài viết..." required>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="card" style="margin-bottom:18px;">
                            ...
                            <div class="form-group">
                                <div class="check-group">
                                    ...
                                    <label for="featuredCheck">Tin nổi bật</label>
                                </div>
                            </div>
                            <div class="form-actions">
                                <a href="tin-tuc-admin.php" class="btn btn-outline">Hủy</a>
    ...
    <script>
        ...
        function loadCategories(selectedId) {
            fetch('api/news-categories.php?t=' + Date.now())
                .then(r => r.json())
                .then(res => {
                    const sel = document.getElementById('categorySelect');
                    sel.innerHTML = '<option value="">-- Chọn danh mục --</option>';
                    if (res.success && res.data) {
                        res.data.filter(c => c.status === 'active').forEach(c => {
        ...
        // Auto-generate slug on title blur
            ...
            fetch(url, {
                ...
                .then(res => {
                    ...
                    if (res.success) {
                        ...
                        if (!isEdit) {
                            setTimeout(() => window.location.href = 'tin-tuc-admin.php', 1000);
                        }
                    } else {
