...
<body>
    ...
    <main class="body-content">
        ...
        <section class="mobile slider show-on-scroll home-page" data-sizes="50vw" id="mb_slider_cover">
            ...
            <a href="./index.php" class="slider-item" title="">
                ...
                <img src="assets/img/banner/banner1.jpeg" data-home-banner-slot="1" alt="">

            </a>

            <a href="./index.php" class="slider-item" title="">

                <img src="assets/img/banner/banner2.jpeg" data-home-banner-slot="2" alt="">

            </a>

            <a href="./index.php" class="slider-item" title="">

                <img src="assets/img/banner/banner3.jpeg" data-home-banner-slot="3" alt="">
        ...
        <section id="principal-welcome" class="show-on-scroll home-page">
            ...
            <div class="container-fluid" style="padding: 0 40px;">
                ...
                <div class="principal-welcome-wrapper" style="padding: 20px 0 10px  0;">
        ...
        <section id="olympia-level-training" class="show-on-scroll home-page" style="position: relative; z-index: 1;">
            ...
            <div class="olympia-level-training">
                ...
                <div class="olympia-level-right olympia-level-right-pc text-left"
                    ...
                    <p class="olympia-level-content font-avenir-regular" style="font-size: 28px; line-height: 1.5; ">Gia nhập cộng đồng Meyschool để trải nghiệm môi
        ...
        <section id="olympia-testimonial">
            <h2 class="font-garamond-bold" style="font-size: 50px; margin: 0 auto 60px auto; max-width: 1043px; text-align: center;">Thông tin
                tuyển sinh</h2>
            <div id="recruitment-cards-container" class="ts-recruitment-grid" style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 30px; max-width: 1400px; margin: 0 auto; padding: 0 40px;">
                <!-- Cards will be loaded dynamically from database -->
            </div>
            <style>
                .ts-recruitment-grid {
                    align-items: stretch;
                ...
                .ts-recruit-card > div:nth-child(2) {
                    flex: 1;
                    display: flex;
                    flex-direction: column;
                }
    ...
    <script>
        ...
        (function() {
            ...
            $.getJSON('api/recruitment-cards-public.php', function(res) {
                var container = document.getElementById('recruitment-cards-container');
                ...
                res.data.forEach(function(card) {
                    html += '<div class="ts-recruit-card" style="background: #fff; border-radius: 20px; overflow: hidden; box-shadow: 0 8px 30px rgba(0,0,0,0.08); transition: all 0.3s ease;">';
                    html += '<div style="padding: 20px 20px 0;">';
                    html += '<div style="aspect-ratio: 1/1; border-radius: 14px; overflow: hidden;">';
                    html += '<img src="' + escHtml(card.image) + '" alt="' + escHtml(card.title) + '" style="width: 100%; height: 100%; object-fit: cover; display: block;" onerror="this.src=\'assets/img/favicon.png\'">';
                    html += '</div>';
                    html += '</div>';
                    html += '<div style="padding: 24px;">';
                    html += '<h3 style="font-size: 18px; font-weight: 700; color: #23336b; margin: 0 0 12px; line-height: 1.4;">' + escHtml(card.title) + '</h3>';
                    html += '<p style="font-size: 14px; color: #666; margin: 0 0 20px; line-height: 1.6;">' + escHtml(card.description) + '</p>';
                    html += '<a href="' + escHtml(card.button_link) + '" style="display: block; width: 100%; text-align: center; padding: 10px 24px; background: #53AFDA; color: #fff; text-decoration: none; border-radius: 25px; font-size: 14px; font-weight: 600; transition: all 0.3s;">' + escHtml(card.button_text || 'Chi tiết') + '</a>';
                    html += '</div>';
                    html += '</div>';
                });
