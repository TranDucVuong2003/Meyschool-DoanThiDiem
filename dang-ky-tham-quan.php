    ...
    <main class="body-content tour-page">
        <section class="tour-hero">
            <div class="tour-wide" data-aos="fade-up">
                ...
                <p>Mời quý phụ huynh trải nghiệm trực tiếp không gian học tập, chương trình giáo dục và môi trường sinh
                    hoạt của học sinh. Nhà trường sẽ liên hệ xác nhận lịch phù hợp ngay sau khi nhận đăng ký.</p>
            </div>
        </section>
            ...
            <div class="tour-wide tour-grid">
                    ...
                    <form class="tour-form" id="tour-register-form" action="api/submit-tham-quan.php" method="post">
                        ...
                        <div class="form-group full">
                            ...
                            <textarea name="message"
                                placeholder="Nhập ghi chú hoặc câu hỏi của quý phụ huynh"></textarea>
                        </div>
                        ...
                        <p class="tour-note">Bằng việc gửi thông tin, quý phụ huynh đồng ý để nhà trường liên hệ tư vấn
                            và xác nhận lịch tham quan.</p>
                    </form>
                </article>
                ...
                <aside class="tour-side" data-aos="fade-up" data-aos-delay="120">
                    ...
                    <div class="tour-side-card">
                        ...
                        <p style="margin-bottom: 10px;">Một vài hình ảnh thực tế để phụ huynh có cái nhìn chân thực
                            trước buổi tham quan.</p>
                        <div class="tour-gallery">
                            <figure><img src="storage/olympia-schools-1.jpg" alt="Toàn cảnh Meyschool Đoàn Thị Điểm">
                            </figure>
                            <figure><img src="storage/olympia-hoc-sinh-tieu-hoc.jpg" alt="Hoạt động học sinh"></figure>
                            <figure><img src="storage/olympia-khai-truong-9-1180x720.jpg"
                                    alt="Không gian học tập hiện đại"></figure>
