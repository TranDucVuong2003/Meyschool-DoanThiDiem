...
<head>
    ...
    <style>
        ...
        .ad-page {
            background: radial-gradient(circle at 0% 0%, #eaf7ff 0%, #f8fcff 43%, #ffffff 100%);
            color: var(--ad-ink);
        }
        ...
        .ad-hero {
            ...
            background: linear-gradient(130deg, rgba(67, 155, 212, 0.95) 0%, rgba(77, 176, 228, 0.9) 68%, rgba(77, 176, 228, 0.84) 100%), url('storage/banner/trung-hoc.jpg') center/cover no-repeat;
        }
        ...
        .ad-intro {
            ...
            border-radius: 22px;
            box-shadow: 0 14px 30px rgba(16, 49, 79, 0.1);
            padding: 24px;
            margin-bottom: 24px;
        }
        ...
        .ad-mini-gallery figcaption {
            ...
            font-weight: 700;
            color: #fff;
            background: linear-gradient(to top, rgba(23, 64, 98, 0.84), rgba(23, 64, 98, 0));
        }
        ...
        .admission-card li {
            padding: 10px 0;
            border-bottom: 1px solid rgba(67, 155, 212, 0.12);
            font-size: 15px;
            color: #3f6686;
            line-height: 1.65;
        }
        ...
        .admission-card li strong {
            color: #2d7bb1;
        }

        .process-section {
            background: linear-gradient(130deg, rgba(67, 155, 212, 0.96), rgba(77, 176, 228, 0.9));
            color: #fff;
            padding: 30px 24px;
            border-radius: 18px;
            box-shadow: 0 14px 30px rgba(16, 49, 79, 0.14);
        }
        ...
        .ad-gallery figure.tall {
            grid-column: span 2;
            grid-row: span 2;
            min-height: 370px;
        }

        .ad-gallery figure.wide {
            grid-column: span 4;
            min-height: 180px;
        }

        .ad-gallery figure.small {
            grid-column: span 2;
        }
