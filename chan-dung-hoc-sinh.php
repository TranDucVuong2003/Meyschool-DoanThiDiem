            ...
            <div class="student-wrap sp-layout">
                <div class="sp-content">
                    <article class="sp-card" data-aos="fade-up">
                        <h2>Chân dung học sinh Meyschool</h2>
                        <div style="border-left:4px solid var(--sp-blue-1);border-radius:14px;padding:16px 20px;background:linear-gradient(120deg,#f4fbff 0%,#ecf8ff 100%);margin-bottom:16px;">
                            <p style="margin:0 0 10px;">Học sinh Meyschool là những công dân tương lai:</p>
                            <ul style="margin:0 0 10px;padding-left:0;list-style:none;display:grid;gap:8px;">
                                <li style="display:flex;align-items:flex-start;gap:10px;"><span style="color:var(--sp-blue-1);font-weight:800;font-size:16px;line-height:1.5;">&#10003;</span><span>Tự tin, chủ động trong học tập và cuộc sống</span></li>
                                <li style="display:flex;align-items:flex-start;gap:10px;"><span style="color:var(--sp-blue-1);font-weight:800;font-size:16px;line-height:1.5;">&#10003;</span><span>Có tư duy sáng tạo và năng lực giải quyết vấn đề</span></li>
                                <li style="display:flex;align-items:flex-start;gap:10px;"><span style="color:var(--sp-blue-1);font-weight:800;font-size:16px;line-height:1.5;">&#10003;</span><span>Giàu lòng nhân ái và tinh thần trách nhiệm</span></li>
                                <li style="display:flex;align-items:flex-start;gap:10px;"><span style="color:var(--sp-blue-1);font-weight:800;font-size:16px;line-height:1.5;">&#10003;</span><span>Sẵn sàng hội nhập với nền tảng ngôn ngữ và công nghệ</span></li>
                            </ul>
                            <p style="margin:0;font-style:italic;color:#2f79ad;font-weight:600;">Mỗi học sinh đều có một hành trình riêng, được tôn trọng và phát triển theo năng lực cá nhân.</p>
                        </div>
                    </article>
