...
<head>
    ...
    <title>Không gian sáng tạo/ Trò chơi dân gian</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta property="og:site_name" content="The Olympia Schools">
    <meta property="og:title" content="Không gian sáng tạo/ Trò chơi dân gian">
    <meta property="og:description" content="">
    <meta property="og:url" content="khong-gian-sang-tao.html">
    <meta property="og:type" content="article">
    <meta property="og:image" content="storage/favicon.png">
    <meta name="twitter:title" content="Không gian sáng tạo/ Trò chơi dân gian">
    ...
    <main class="body-content">
            ...
            <div class="standard__header-cover header_cover show-on-scroll" id="english-header-title">
                ...
                <div class="big-cover-title-box">
                    <ol class="breadcrumb container">
                        ...
                        <li class="breadcrumb-item white"><a href="javascript:;" class="white">Không gian sáng tạo</a></li>
                    </ol>
                    <h1 class="big__header-title container font-garamond-bold white header-title">Không gian sáng tạo/ Trò chơi dân gian</h1>
                </div>
            </div>
        </section>
        ...
        <section class="program-content">
            <div class="container" style="padding: 60px 20px;">
                <h2 style="font-size: 32px; color: #471873; margin-bottom: 30px; font-weight: 600;">Không gian sáng tạo</h2>
                <p style="font-size: 16px; line-height: 1.8; color: #333; margin-bottom: 20px;">
                    Không gian sáng tạo tại Meyschool Đoàn Thị Điểm được thiết kế để khơi dậy 
                    trí tưởng tượng và khuyến khích học sinh khám phá, sáng tạo. Đây là nơi 
                    học sinh có thể tự do thể hiện ý tưởng và phát triển kỹ năng thực hành.
                </p>
                <p style="font-size: 16px; line-height: 1.8; color: #333; margin-bottom: 20px;">
                    Khu vực bao gồm: phòng Makerspace với đầy đủ dụng cụ và vật liệu, 
                    phòng hội họa, phòng âm nhạc, và khu vực ngoài trời cho các hoạt động 
                    nghệ thuật, khoa học và công nghệ.
                </p>
                <h2 style="font-size: 28px; color: #471873; margin-bottom: 20px; margin-top: 40px; font-weight: 600;">Trò chơi dân gian</h2>
                <p style="font-size: 16px; line-height: 1.8; color: #333; margin-bottom: 20px;">
                    Trường tôn trọng và bảo tồn văn hóa truyền thống qua khu vực trò chơi dân gian. 
                    Học sinh được trải nghiệm các trò chơi truyền thống như: nhảy dây, 
                    ô ăn quan, chơi chuyền, kéo co... giúp phát triển thể chất và gắn kết với văn hóa dân tộc.
                </p>
            </div>
        </section>
    </main>
