    ...
    <main class="body-content">
            ...
            <div class="standard__header-cover header_cover show-on-scroll" id="english-header-title">
                ...
                <div class="big-cover-title-box">
                    <ol class="breadcrumb container">
                        ...
                        <li class="breadcrumb-item white"><a href="javascript:;" class="white">Tổng quan campus</a></li>
                    </ol>
                    <h1 class="big__header-title container font-garamond-bold white header-title">Tổng quan campus</h1>
                </div>
            </div>
        </section>
        ...
        <section class="program-content">
            <div class="container" style="padding: 60px 20px;">
                <h2 style="font-size: 32px; color: #471873; margin-bottom: 30px; font-weight: 600;">Tổng quan Campus</h2>
                <p style="font-size: 16px; line-height: 1.8; color: #333; margin-bottom: 20px;">
                    Khuôn viên trường Meyschool Đoàn Thị Điểm trên khu đất rộng 10,000 m² được thiết kế 
                    bởi công ty kiến trúc Mỹ Perkins Eastman với phong cách hiện đại, tạo không gian học tập, 
                    vui chơi, suy nghĩ và sáng tạo cho nhiều đối tượng học sinh.
                </p>
                <p style="font-size: 16px; line-height: 1.8; color: #333; margin-bottom: 20px;">
                    Olympia cho rằng mỗi góc trường, mỗi dãy hành lang, mỗi phòng học đều có thể 
                    là không gian học tập, vì vậy, tất cả được xây dựng với tiêu chí thân thiện, 
                    gần gũi và hướng tới học sinh.
                </p>
                <p style="font-size: 16px; line-height: 1.8; color: #333;">
                    Campus bao gồm 2 tòa nhà chính: tòa Mind và tòa Heart, được kết nối bởi các 
                    khuôn viên xanh mát, tạo nên một môi trường học tập lý tưởng cho học sinh.
                </p>
            </div>
        </section>
    </main>
