        ...
        <div class="thcs-main-layout">
                    ...
                    <ul class="thcs-nav-menu">
                        <li class="thcs-nav-item">
                            <a href="tong-quan-chuong-trinh.php" class="thcs-nav-link">
                                <span class="thcs-nav-thumb"><img src="storage/banner/ve-chung-toi-web.jpg"
                                        alt=""></span>
                                Tổng quan
                            </a>
                        </li>
            ...
            <div class="thcs-content-center">
                <div class="thcs-section-header">
                    ...
                    <p>Chương trình THCS tập trung vào việc phát triển toàn diện học sinh, chuẩn bị cho giai đoạn học
                        tập nâng cao</p>
                </div>
                ...
                <div class="thcs-features-grid">
                    <div class="thcs-feature-card">
                        ...
                        <div class="thcs-feature-content">
                            ...
                            <p>Phát triển khả năng phân tích, đánh giá và giải quyết vấn đề phức tạp thông qua các dự án
                                học thuật.</p>
                        </div>
                    </div>
                    <div class="thcs-feature-card">
                    ...
                    <div class="thcs-feature-card">
                        ...
                        <div class="thcs-feature-content">
                            <h3>Làm việc nhóm</h3>
                            <p>Phát triển kỹ năng hợp tác, giao tiếp và lãnh đạo trong nhóm qua các hoạt động tập thể.
                            </p>
                        </div>
                    </div>
                    <div class="thcs-feature-card">
