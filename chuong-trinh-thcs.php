    ...
    <main class="body-content">
            ...
            <div class="standard__header-cover header_cover show-on-scroll" id="english-header-title">
                ...
                <div class="big-cover-title-box">
                    <ol class="breadcrumb container">
                        ...
                        <li class="breadcrumb-item white"><a href="javascript:;" class="white">Chương trình đào tạo</a></li>
                        <li class="breadcrumb-item white"><a href="javascript:;" class="white">Chương trình THCS</a></li>
                    </ol>
                    <h1 class="big__header-title container font-garamond-bold white header-title">Chương trình THCS</h1>
                </div>
            </div>
        </section>
        ...
        <section class="program-content">
            <div class="container" style="padding: 60px 20px;">
                <h2 style="font-size: 32px; color: #471873; margin-bottom: 30px; font-weight: 600;">Chương trình Trung học cơ sở</h2>
                <p style="font-size: 16px; line-height: 1.8; color: #333; margin-bottom: 20px;">
                    Chương trình Trung học cơ sở (THCS) tại Meyschool Đoàn Thị Điểm 
                    được xây dựng dựa trên chương trình chuẩn của Bộ Giáo dục và Đào tạo, 
                    kết hợp với các phương pháp giảng dạy tiên tiến và định hướng phát triển 
                    toàn diện cho học sinh.
                </p>
                <p style="font-size: 16px; line-height: 1.8; color: #333; margin-bottom: 20px;">
                    Chương trình THCS tập trung phát triển tư duy phản biện, kỹ năng phân tích 
                    và giải quyết vấn đề. Học sinh được khuyến khích tự học, tự nghiên cứu 
                    và phát triển khả năng làm việc nhóm hiệu quả.
                </p>
                <p style="font-size: 16px; line-height: 1.8; color: #333;">
                    Ngoài kiến thức học thuật, chương trình còn chú trọng định hướng nghề nghiệp, 
                    phát triển kỹ năng mềm và giáo dục công dân toàn cầu, 
                    giúp học sinh chuẩn bị tốt cho bậc học THPT và tương lai sau này.
                </p>
            </div>
        </section>
    </main>
