        ...
        <section class="ac-hero">
            <div class="ac-wide ac-hero-grid">
                <div>
                    ...
                    <p>Cập nhật chính thức các thông báo về lịch học, lịch thi, sự kiện quan trọng và các nội dung điều
                        chỉnh trong năm học. Phụ huynh và học sinh vui lòng theo dõi thường xuyên để nắm bắt thông tin
                        kịp thời.</p>
                </div>
                <div class="ac-highlight">
                    <img src="storage/jnp2203-1-1920x1080.jpg" alt="Thông báo mới nhất">
                    <p>Cập nhật liên tục theo tuần để đảm bảo mọi thông tin đến phụ huynh và học sinh nhanh chóng, chính
                        xác.</p>
                </div>
            </div>
        </section>
            ...
            <div class="ac-wide">
                <div class="ac-intro">
                    <article class="ac-card" data-aos="fade-up">
                        ...
                        <p>Trang thông báo tổng hợp toàn bộ các nội dung chính thức từ nhà trường bao gồm lịch học, lịch
                            thi, thay đổi chế độ, sự kiện đặc biệt và các hướng dẫn dành cho phụ huynh, học sinh trong
                            suốt năm học.</p>
                    </article>
                    <div class="ac-kpis" data-aos="fade-up" data-aos-delay="100">
                        <div class="ac-kpi"><strong>50+</strong><span>Thông báo chính thức được phát hành mỗi năm
                                học</span></div>
                        <div class="ac-kpi"><strong>24h</strong><span>Cập nhật nhanh chóng mọi thay đổi quan
                                trọng</span></div>
                        <div class="ac-kpi"><strong>100%</strong><span>Phụ huynh được thông tin đầy đủ qua đa
                                kênh</span></div>
                        <div class="ac-kpi"><strong>5+</strong><span>Danh mục: Lịch học, Tuyển sinh, Sự kiện, Hành
                                chính, Y tế</span></div>
                    </div>
                </div>
                ...
                <div class="ac-grid" id="ac-grid">
                    <article class="ac-item" data-year="lich-hoc" data-aos="fade-up">
                        ...
                        <div class="ac-item-content">
                            ...
                            <p>Nhà trường thông báo lịch học điều chỉnh áp dụng từ tuần đầu tháng 4 cho toàn bộ các cấp
                                học.</p>
                    ...
                    <article class="ac-item" data-year="tuyen-sinh" data-aos="fade-up" data-aos-delay="80">
                        ...
                        <div class="ac-item-content">
                            ...
                            <p>Phụ huynh có thể đăng ký tham quan trực tiếp cơ sở vật chất và tìm hiểu chương trình đào
                                tạo của nhà trường.</p>
                            <a href="javascript:;">Xem chi tiết ›</a>
                        </div>
                    </article>
                    ...
                    <article class="ac-item" data-year="su-kien" data-aos="fade-up" data-aos-delay="140">
                        ...
                        <div class="ac-item-content">
                            ...
                            <p>Sự kiện STEAM quy mô lớn với các hoạt động thực nghiệm khoa học, lập trình và sáng tạo
                                công nghệ.</p>
                            <a href="javascript:;">Xem chi tiết ›</a>
                        </div>
                    </article>
                    ...
                    <article class="ac-item" data-year="hanh-chinh" data-aos="fade-up">
                        ...
                        <div class="ac-item-content">
                            ...
                            <p>Phụ huynh vui lòng cập nhật thông tin cá nhân và liên lạc trên hệ thống quản lý học sinh
                                theo hướng dẫn.</p>
                            <a href="javascript:;">Xem chi tiết ›</a>
                        </div>
                    </article>
                    ...
                    <article class="ac-item" data-year="lich-hoc" data-aos="fade-up" data-aos-delay="80">
                        ...
                        <div class="ac-item-content">
                            ...
                            <p>Thực đơn bán trú được cập nhật hàng tuần, đảm bảo dinh dưỡng cân đối và an toàn vệ sinh
                                thực phẩm.</p>
                            <a href="javascript:;">Xem chi tiết ›</a>
                        </div>
                    </article>
                    ...
                    <article class="ac-item" data-year="hanh-chinh" data-aos="fade-up" data-aos-delay="140">
                        ...
                        <div class="ac-item-content">
                            ...
                            <p>Thông báo thay đổi lộ trình xe bus phục vụ học sinh khu vực Nam Từ Liêm từ tuần tiếp
                                theo.</p>
                            <a href="javascript:;">Xem chi tiết ›</a>
                        </div>
                    </article>
