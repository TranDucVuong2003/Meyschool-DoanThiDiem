...
<body>
    ...
    (function() {
        ...
        function loadNotifications() {
            ...
            $.getJSON('api/notifications-public.php?' + params, function(res) {
                if (!res.success || !res.data.length) {
                    grid.innerHTML =
                        '<p style="grid-column:1/-1;text-align:center;color:#999;padding:40px 0;">Chưa có thông báo nào.</p>';
        ...
        $(paginationEl).on('click', '.pg-btn', function() {
            ...
            loadNotifications();
            window.scrollTo({
                top: document.querySelector('.news-heading').offsetTop - 80,
                behavior: 'smooth'
            });
        });
