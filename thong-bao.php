    ...
    <main class="body-content">
            ...
            <div class="standard__header-cover header_cover show-on-scroll" id="english-header-title">
                ...
                <div class="big-cover-title-box">
                    <ol class="breadcrumb container">
                        ...
                        <li class="breadcrumb-item white"><a href="javascript:;" class="white">Thông báo</a></li>
                    </ol>
                    <h1 class="big__header-title container font-garamond-bold white header-title">Thông báo</h1>
                </div>
            </div>
        </section>
        ...
        <section class="program-content">
            <div class="container" style="padding: 60px 20px;">
                <h2 style="font-size: 32px; color: #471873; margin-bottom: 30px; font-weight: 600;">Thông báo</h2>
                <p style="font-size: 16px; line-height: 1.8; color: #333; margin-bottom: 20px;">
                    Trang thông báo chính thức của trường Meyschool Đoàn Thị Điểm. 
                    Cập nhật các thông tin quan trọng về lịch học, lịch thi, 
                    thay đổi chương trình và các thông báo khẩn cấp.
                </p>
                <p style="font-size: 16px; line-height: 1.8; color: #333; margin-bottom: 20px;">
                    Phụ huynh và học sinh vui lòng theo dõi thường xuyên để cập nhật 
                    thông tin mới nhất từ nhà trường. Các thông báo quan trọng sẽ được 
                    gửi đồng thời qua email và ứng dụng MyTOS.
                </p>
                <p style="font-size: 16px; line-height: 1.8; color: #333;">
                    Mọi thắc mắc về thông báo vui lòng liên hệ văn phòng nhà trường 
