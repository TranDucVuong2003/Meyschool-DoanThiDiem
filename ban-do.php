    ...
    <main class="body-content map-page">
        <section class="map-hero">
            <div class="map-wide" data-aos="fade-up">
                ...
                <p class="map-hero-sub">Định vị nhanh khuôn viên trường, chọn lộ trình thuận tiện cho phụ huynh và học sinh, đồng thời xem thêm các góc hình ảnh chân thực về không gian học tập.</p>
            </div>
        </section>
        ...
        <section class="map-content">
            <div class="map-wide map-grid">
                <article class="map-card" data-aos="fade-up">
                    ...
                    <p>Trường Meyschool Đoàn Thị Điểm tọa lạc tại Khu đô thị Trung Văn, Nam Từ Liêm, Hà Nội. Vị trí kết nối tốt với các trục đường chính, phù hợp cho phụ huynh di chuyển vào giờ cao điểm.</p>
                    <p>Phụ huynh có thể mở trực tiếp bản đồ để lựa chọn cung đường tối ưu theo thời gian thực. Khu vực trường có bãi đỗ xe cho phụ huynh và khách đến tham quan.</p>
                    ...
                    <div class="map-actions">
                        <a href="https://maps.app.goo.gl/ABC123" target="_blank" class="map-btn map-btn-primary">Mở Google Maps</a>
                ...
                <aside class="map-side" data-aos="fade-up" data-aos-delay="120">
                    <div class="map-side-card">
                        ...
                        <p>Gợi ý tìm kiếm trên bản đồ: Meyschool Đoàn Thị Điểm hoặc The Olympia Schools. Khi đến cổng trường, phụ huynh có thể liên hệ bảo vệ để được hướng dẫn khu vực đỗ xe và đón học sinh.</p>
                    </div>

                    <div class="map-side-card">
                        <h4>Hình ảnh khuôn viên</h4>
                        <p>Không gian học tập xanh, thoáng và hiện đại, tạo cảm giác an toàn, thân thiện cho học sinh mỗi ngày.</p>
                        <div class="map-gallery">
                            <figure><img src="storage/jnp2203-1-1920x1080.jpg" alt="Toàn cảnh khuôn viên trường"></figure>
                            <figure><img src="storage/olympia-schools-1.jpg" alt="Không gian hoạt động của học sinh"></figure>
                            <figure><img src="storage/olympia-khai-truong-9-1180x720.jpg" alt="Khu vực sinh hoạt chung"></figure>
                            <figure><img src="storage/olympia-hoc-sinh-tieu-hoc.jpg" alt="Học sinh tại Meyschool Đoàn Thị Điểm"></figure>
                        </div>
                    </div>
                </aside>
            </div>
