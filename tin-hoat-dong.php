    ...
    <main class="body-content">
            ...
            <div class="standard__header-cover header_cover show-on-scroll" id="english-header-title">
                ...
                <div class="big-cover-title-box">
                    <ol class="breadcrumb container">
                        ...
                        <li class="breadcrumb-item white"><a href="javascript:;" class="white">Tin tức</a></li>
                        <li class="breadcrumb-item white"><a href="javascript:;" class="white">Tin hoạt động</a></li>
                    </ol>
                    <h1 class="big__header-title container font-garamond-bold white header-title">Tin hoạt động</h1>
                </div>
            </div>
        </section>
        ...
        <section class="program-content">
            <div class="container" style="padding: 60px 20px;">
                <h2 style="font-size: 32px; color: #471873; margin-bottom: 30px; font-weight: 600;">Tin hoạt động</h2>
                <p style="font-size: 16px; line-height: 1.8; color: #333; margin-bottom: 20px;">
                    Cập nhật các tin tức hoạt động mới nhất của trường Meyschool Đoàn Thị Điểm, 
                    bao gồm các chương trình hợp tác quốc tế, đối tác chiến lược và các hoạt động 
                    nổi bật trong cộng đồng giáo dục.
                </p>
                <p style="font-size: 16px; line-height: 1.8; color: #333; margin-bottom: 20px;">
                    Meyschool tự hào là đối tác của nhiều tổ chức giáo dục uy tín trên thế giới, 
                    mang đến cho học sinh cơ hội tiếp cận với nền giáo dục tiên tiến và các 
                    chương trình trao đổi quốc tế.
                </p>
                <p style="font-size: 16px; line-height: 1.8; color: #333;">
                    Theo dõi trang này để cập nhật thông tin về các sự kiện hợp tác, 
                    chương trình liên kết và hoạt động ngoại giao giáo dục của nhà trường.
                </p>
            </div>
        </section>
    </main>
