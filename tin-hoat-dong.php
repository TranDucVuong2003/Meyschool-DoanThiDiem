        ...
        <section class="ac-hero">
            <div class="ac-wide ac-hero-grid">
                <div>
                    ...
                    <p>Cập nhật liên tục các chương trình nổi bật tại Meyschool Đoàn Thị Điểm: dự án học tập liên môn,
                        hoạt động ngoại khóa, ngày hội trải nghiệm, các sự kiện hợp tác quốc tế và hành trình phát triển
                        toàn diện của học sinh trong từng giai đoạn.</p>
                </div>
                <div class="ac-highlight">
                    <img src="storage/jnp2203-1-1920x1080.jpg" alt="Hoạt động nổi bật">
                    <p>Mỗi tuần, nhà trường triển khai chuỗi hoạt động đa dạng nhằm nuôi dưỡng tri thức, cảm xúc tích
                        cực và kỹ năng hội nhập cho học sinh ở mọi cấp học.</p>
                </div>
            </div>
        </section>
            ...
            <div class="ac-wide">
                <div class="ac-intro">
                    <article class="ac-card" data-aos="fade-up">
                        ...
                        <p>Trang tin hoạt động được xây dựng theo định hướng trực quan - chi tiết - cập nhật nhanh, giúp
                            phụ huynh và học sinh theo dõi toàn bộ hành trình học đường qua từng sự kiện cụ thể. Nội
                            dung tập trung vào trải nghiệm thực tế, sản phẩm học tập và những khoảnh khắc giàu cảm hứng
                            trong đời sống Meyschool.</p>
                    </article>
                    <div class="ac-kpis" data-aos="fade-up" data-aos-delay="100">
                        <div class="ac-kpi"><strong>120+</strong><span>Hoạt động học thuật và ngoại khóa mỗi năm
                                học</span></div>
                        <div class="ac-kpi"><strong>30+</strong><span>Sự kiện hợp tác - kết nối cộng đồng và đối tác
                                giáo dục</span></div>
                        <div class="ac-kpi"><strong>4</strong><span>Nhóm chủ đề: Học thuật, Nghệ thuật, Thể thao, Dự án
                                xã hội</span></div>
                        <div class="ac-kpi"><strong>100%</strong><span>Học sinh tham gia ít nhất một hoạt động trải
                                nghiệm mỗi tháng</span></div>
                    </div>
                </div>
                ...
                <div class="ac-grid" id="ac-grid">
                    <article class="ac-item" data-year="hoc-thuat" data-aos="fade-up">
                        ...
                        <div class="ac-item-content">
                            ...
                            <p>Học sinh trình bày mô hình sáng tạo, vận dụng kiến thức Toán - Khoa học - Công nghệ để
                                giải quyết vấn đề thực tiễn trong đời sống.</p>
                    ...
                    <article class="ac-item" data-year="van-hoa" data-aos="fade-up" data-aos-delay="80">
                        ...
                        <div class="ac-item-content">
                            ...
                            <p>Không gian đa văn hóa với các workshop ngôn ngữ, nghệ thuật và giao lưu chuyên đề giúp
                                học sinh mở rộng góc nhìn quốc tế.</p>
                            <a href="javascript:;">Xem chi tiết ›</a>
                        </div>
                    </article>
                    ...
                    <article class="ac-item" data-year="the-thao" data-aos="fade-up" data-aos-delay="140">
                        ...
                        <div class="ac-item-content">
                            ...
                            <p>Các môn thi đấu đa dạng từ bóng rổ, bơi lội đến điền kinh, giúp học sinh phát triển thể
                                chất, bản lĩnh và tinh thần fair-play.</p>
                            <a href="javascript:;">Xem chi tiết ›</a>
                        </div>
                    </article>
                    ...
                    <article class="ac-item" data-year="hoc-thuat" data-aos="fade-up">
                        ...
                        <div class="ac-item-content">
                            ...
                            <p>Học sinh nghiên cứu theo nhóm, tổng hợp kiến thức từ nhiều môn học để tạo ra sản phẩm học
                                tập có giá trị ứng dụng thực tế.</p>
                            <a href="javascript:;">Xem chi tiết ›</a>
                        </div>
                    </article>
                    ...
                    <article class="ac-item" data-year="van-hoa" data-aos="fade-up" data-aos-delay="80">
                        ...
                        <div class="ac-item-content">
                            ...
                            <p>Tạo không gian sáng tạo cho học sinh thể hiện năng khiếu âm nhạc, hội họa và chia sẻ đam
                                mê với sách.</p>
                            <a href="javascript:;">Xem chi tiết ›</a>
                        </div>
                    </article>
                    ...
                    <article class="ac-item" data-year="the-thao" data-aos="fade-up" data-aos-delay="140">
                        ...
                        <div class="ac-item-content">
                            ...
                            <p>Sân chơi thể thao lành mạnh với đa dạng bộ môn, rèn luyện sức khỏe và tinh thần thể thao
                                cao thượng cho học sinh mọi cấp học.</p>
                            <a href="javascript:;">Xem chi tiết ›</a>
                        </div>
                    </article>
                </div>
