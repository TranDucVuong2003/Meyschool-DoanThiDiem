    ...
    <main class="body-content primary-page">
        <section class="hero">
            <div class="wrap hero-grid">
                <div class="hero-copy" data-aos="fade-up">
                    <span class="kicker">Tuyển sinh 2026-2027 . Khối Tiểu học</span>
            ...
            <div class="wrap">
                ...
                <div class="story-grid">
                    <article class="story" data-aos="fade-up">
                        <img src="assets/banner/banner1.jpeg" alt="Buổi sáng học tập">
                    ...
                    <article class="story" data-aos="fade-up" data-aos-delay="240">
                        <img src="assets/banner/banner3.jpeg" alt="Kết nối gia đình">
                        <div class="story-copy">
                            <span>Cuối ngày</span>
        ...
        <section class="section">
            <div class="wrap capability-wrap">
                <div class="media" data-aos="fade-right">
                    <img src="assets/banner/banner2.jpeg" alt="Năng lực học sinh tiểu học">
                </div>
            ...
            <div class="wrap policy-grid">
                ...
                <div class="policy-box" data-aos="fade-left">
                    ...
                    <div class="policy-table">
                        ...
                        <div class="policy-row"><strong>Hỗ trợ</strong><span>Bộ phận tuyển sinh tư vấn trực tiếp các khoản
            ...
            <div class="wrap">
                ...
                <div class="gallery">
                    <div class="gallery-main">
                        <div class="card" data-aos="fade-right"><img src="assets/banner/banner3.jpeg"
                ...
                <div class="cta-panel" data-aos="zoom-in-up">
                    <div class="cta-grid">
                        <div>
                            ...
                            <p>Nếu phụ huynh muốn xem thực tế môi trường học tập, tìm hiểu hồ sơ hoặc cần lộ trình phù hợp
