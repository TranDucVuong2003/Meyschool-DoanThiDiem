$(function () {
  ...
  $(".hotline-phone-ring-wrap").each(function () {
    var $wrap = $(this);
    if ($wrap.find(".hotline-social-stack").length) {
      return;
    }

    var socialHtml =
      "" +
      '<div class="hotline-social-stack">' +
      '<a class="hotline-social-btn hotline-social-zalo" href="https://zalo.me/0934525889" target="_blank" rel="noopener noreferrer" aria-label="Chat Zalo"><span class="hotline-social-icon" aria-hidden="true"></span></a>' +
      '<a class="hotline-social-btn hotline-social-messenger" href="https://m.me/theolympiaschools" target="_blank" rel="noopener noreferrer" aria-label="Chat Messenger"><span class="hotline-social-icon" aria-hidden="true"></span></a>' +
      "</div>";

    $wrap.prepend(socialHtml);
  });
});
