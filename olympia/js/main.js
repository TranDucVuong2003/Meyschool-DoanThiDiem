$(document).ready(function () {
  ...
  for (var i = 0; i < detailItem.length; i++) {
    ...
    detailItem[i].addEventListener("mouseout", function (e) {
      e.preventDefault();
      var current = document.getElementsByClassName("ach-item active-item");
  ...
  for (var j = 0; j < vendorItem.length; j++) {
    vendorItem[j].addEventListener("mouseover", function (e) {
      ...
      var screenWidth = window.innerWidth;
      var contentWidth =
        document.getElementsByClassName("tabs-content")[0].offsetWidth;
      var leftWidth = this.parentNode.offsetLeft + popupItem.offsetLeft;
...
function headerEffect() {
  ...
  for (var i = 0; i < btnDropdownPc.length; i++) {
    btnDropdownPc[i].addEventListener("click", function (e) {
      ...
      var pcSubItem = document.getElementsByClassName(
        "pc-sub-item has-children-2",
      );
      for (var j = 0; j < pcSubItem.length; j++) {
        if (
          (pcSubItem[j] !== pcSubItemParent) &
          pcSubItem[j].classList.contains("active-sub-2")
        ) {
          pcSubItem[j].classList.remove("active-sub-2");
          var pcSubItemMenu =
            pcSubItem[j].getElementsByClassName("pc-menu-sub-2")[0];
          var pcSubItemMenuItem =
            pcSubItemMenu.getElementsByClassName("pc-sub-item-2");
          var term = 0;
      ...
      var pcMenuSub2 =
        pcSubItemParent.getElementsByClassName("pc-menu-sub-2")[0];
      var pcMenuSub2Item =
        pcSubItemParent.getElementsByClassName("pc-sub-item-2");
  ...
  menuMb.onclick = function () {
    ...
    translateEffect(menuMbContainer[0], width * 0.8, 0, 300, 10, "x");
    menuMbContainer[0].style.display = "block";

    // Show overlay backdrop
    var overlay = document.getElementById("mb-menu-overlay");
    if (!overlay) {
      overlay = document.createElement("div");
      overlay.id = "mb-menu-overlay";
      overlay.style.cssText =
        "position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.4);z-index:9;opacity:0;transition:opacity 0.3s ease;";
    ...
    var mbLanguage = document.getElementsByClassName("mb-language")[0];
    if (mbLanguage) {
      mbLanguage.style.opacity = 0;
      opacityEffect(mbLanguage, 0, 1, 700, 10, 1000);
    }
  };
  btnMbClose.onclick = function () {
    menuMbContainer[0].classList.remove("active");
    translateEffect(menuMbContainer[0], 0, width * 0.8, 400, 10, "x");
    ...
    for (var i = 0; i < itemList.length; i++) {
      if (itemList[i].classList.contains("has-children")) {
        ...
        var subMenu = itemList[i].getElementsByClassName("mb-menu-sub")[0];
        if (subMenu) {
  ...
  //when click item menu, toggle accordion dropdown
  for (var i = 0; i < itemMenus.length; i++) {
    itemMenus[i].addEventListener("click", function (e) {
      if (this.parentNode.classList.contains("has-children")) {
        e.preventDefault();

        var clickedItem = this.parentNode;
        var mbMenuSub = clickedItem.getElementsByClassName("mb-menu-sub")[0];

        // Close other open items
        var allItems = document.getElementsByClassName("mb-menu-item");
        for (var j = 0; j < allItems.length; j++) {
          if (
            allItems[j] !== clickedItem &&
            allItems[j].classList.contains("active-item")
          ) {
            allItems[j].classList.remove("active-item");
            var otherSub = allItems[j].getElementsByClassName("mb-menu-sub")[0];
            if (otherSub) {
        ...
        // Toggle clicked item
        if (clickedItem.classList.contains("active-item")) {
          clickedItem.classList.remove("active-item");
          mbMenuSub.style.maxHeight = "0";
          setTimeout(function () {
            mbMenuSub.style.display = "none";
          }, 350);
        } else {
          clickedItem.classList.add("active-item");
          mbMenuSub.style.display = "block";
          mbMenuSub.style.maxHeight = mbMenuSub.scrollHeight + "px";
        }
      }
    });
  }
...
function addEffectHome(element) {
  ...
  switch (elementName) {
    ...
    case "olympia-level-training":
      ...
      var level_2 = element.children[0].getElementsByClassName(
        "olympia-level-right",
      )[0];
    ...
    case "testimonial":
      ...
      if (!slick_item.length) break;
      var slick_item_info = slick_item[0].getElementsByClassName(
        "olympia-testimonial-entry",
      )[0];
      var slick_item_img = slick_item[0].getElementsByClassName(
    ...
    case "pc_slider_cover":
      ...
      if (pc_slider.classList.contains("is-visible")) {
        ...
        for (var i = 0; i < slick_item.length; i++) {
          var slick_item_info =
            slick_item[i].getElementsByClassName("slider-title-box")[0];
...
function addEffectAboutUs(element) {
  ...
  switch (elementName) {
    case "tam-nhin-su-menh":
      var item_1 =
        element.children[1].getElementsByClassName("tnsm-block-1")[0];
      ...
      var item_list = [item_1, item_2, item_3, item_4, item_5];
...
function addEffectLearningProgram(element) {
  ...
  switch (elementName) {
    ...
    case "lo-trinh":
      ...
      var level_connect_1 =
        element.children[1].getElementsByClassName("level-connect-1")[0];
      var level_connect_2 =
        element.children[1].getElementsByClassName("level-connect-2")[0];
      var level_connect_3 =
        element.children[1].getElementsByClassName("level-connect-3")[0];
...
function addEffectEnglishProgram(element) {
  ...
  switch (elementName) {
    ...
    case "phuong-phap-hoc":
      ...
      var method_item =
        element.children[1].getElementsByClassName("method-item");
      var term = 300;
    ...
    case "nen-tang":
      var nt_title =
        element.children[0].getElementsByClassName("font-garamond-bold");
      var nt_content =
        element.children[0].getElementsByClassName("foundation-content");
    ...
    case "doi-song-hoc-duong":
      ...
      var grid_row_1 =
        element.children[0].getElementsByClassName("grid-row-1")[0];
      var grid_row_2 =
        element.children[0].getElementsByClassName("grid-row-2")[0];
...
function addEffectSummerProgram(element) {
  ...
  switch (elementName) {
    ...
    case "summer-slide":
      ...
      if (!slick_item.length) break;
      var slick_item_img =
        slick_item[0].getElementsByClassName("summer-slide-img")[0];
      var slick_item_info =
        slick_item[0].getElementsByClassName("summer-slide-info")[0];
...
function openCity(evt, cityName, page = null) {
  ...
  if (page === "csvc") {
    ...
    var tabContentItem =
      tabContent.children[0].getElementsByClassName("img-box");
    var tabName =
      evt.currentTarget.getElementsByClassName("csvc-total-item")[0];
