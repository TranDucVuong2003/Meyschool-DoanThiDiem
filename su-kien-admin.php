...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        .event-date-cell .date {
            font-weight: 600;
        }

        .event-date-cell .location {
            font-size: 12px;
            color: var(--muted);
            margin-top: 2px;
        }
    ...
    <script>
        ...
        function loadEvents(page) {
            ...
            fetch('api/events.php?' + params)
                .then(r => r.json())
                .then(res => {
                    if (res.success) renderTable(res.data, res.total, res.page, res.totalPages);
                })
        ...
        document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
            ...
            fetch('api/events.php?_method=DELETE', {
                    method: 'POST',
                    body: fd
                })
                .then(r => r.json())
        ...
        document.getElementById('searchInput').addEventListener('input', function() {
            ...
            searchTimer = setTimeout(() => loadEvents(1), 350);
        });
