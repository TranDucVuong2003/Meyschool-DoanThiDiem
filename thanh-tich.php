        ...
        <section class="ac-hero">
            <div class="ac-wide ac-hero-grid">
                <div>
                    ...
                    <p>Hành trình ghi dấu những cột mốc học thuật, hợp tác quốc tế và phát triển toàn diện của nhà trường qua từng năm học. Mỗi thành tựu là kết quả của nỗ lực bền bỉ từ học sinh, giáo viên và cộng đồng phụ huynh.</p>
                </div>
                <div class="ac-highlight">
                    <img src="storage/thanh-tich/chung-nhan-wasc.jpg" alt="Thành tích nổi bật">
                    <p>Nhà trường liên tục mở rộng hợp tác chiến lược, chuẩn hóa chất lượng đào tạo và khẳng định vị thế trong hệ sinh thái giáo dục song ngữ hội nhập.</p>
                </div>
            </div>
        </section>
            ...
            <div class="ac-wide">
                <div class="ac-intro">
                    <article class="ac-card" data-aos="fade-up">
                        ...
                        <p>Từ các chứng nhận kiểm định quốc tế đến các chương trình hợp tác giáo dục toàn cầu, Meyschool liên tục xây dựng nền tảng học thuật vững chắc cho học sinh. Trên hành trình này, nhà trường chú trọng đồng thời chất lượng đào tạo, năng lực hội nhập và trải nghiệm cá nhân hóa của người học.</p>
                    </article>
                    <div class="ac-kpis" data-aos="fade-up" data-aos-delay="100">
                        <div class="ac-kpi"><strong>20+</strong><span>Năm phát triển liên tục đổi mới mô hình giáo dục</span></div>
                        <div class="ac-kpi"><strong>50+</strong><span>Dự án hợp tác, trao đổi và kết nối học thuật quốc tế</span></div>
                        <div class="ac-kpi"><strong>1000+</strong><span>Học sinh tốt nghiệp tiếp tục học tập tại các trường đại học chất lượng</span></div>
                        <div class="ac-kpi"><strong>Top</strong><span>Đơn vị tiên phong về chương trình song ngữ hội nhập tại Hà Nội</span></div>
                                                    </div>
                                                </div>
                ...
                <div class="ac-grid" id="ac-grid">
                    <article class="ac-item" data-year="2021-2022" data-aos="fade-up">
                        ...
                        <div class="ac-item-content">
                            ...
                            <p>Đánh dấu bước tiến quan trọng trong chiến lược nâng cao chất lượng giáo dục theo chuẩn quốc tế.</p>
                            <a href="wasc-chinh-thuc-cong-nhan-olympia-dat-chuan-kiem-dinh-toan-dien.html">Xem chi tiết ›</a>
                                            </div>
                    </article>
                    ...
                    <article class="ac-item" data-year="2022-2023" data-aos="fade-up" data-aos-delay="140">
                        ...
                        <div class="ac-item-content">
                            ...
                            <a href="olympia-hop-tac-giao-duc-voi-he-thong-cac-truong-cong-lap-portland-hoa-ky.html">Xem chi tiết ›</a>
                                                    </div>
                    </article>

                    <article class="ac-item" data-year="2023-2024" data-aos="fade-up">
                        <img src="storage/375858674-702828201882368-5966117559020271070-n.jpg" alt="Microsoft Showcase School">
                        <div class="ac-item-content">
                            ...
                            <a href="olympia-tiep-tuc-duoc-cong-nhan-la-truong-hoc-dien-hinh-microsoft.html">Xem chi tiết ›</a>
                        </div>
                    </article>

                    <article class="ac-item" data-year="2023-2024" data-aos="fade-up" data-aos-delay="80">
                        <img src="storage/z4838899140265-f68c68a84f8e8562b2f1c02adf81ef02-2.png" alt="Hợp tác Singapore">
                        <div class="ac-item-content">
                            <span class="ac-item-year">2023 - 2024</span>
